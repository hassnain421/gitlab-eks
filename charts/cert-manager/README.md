...
```bash
$ kubectl apply -f https://github.com/cert-manager/cert-manager/releases/download/v1.12.11/cert-manager.crds.yaml
```
...
$ helm install my-release --namespace cert-manager --version v1.12.11 jetstack/cert-manager
```
...
```console
$ kubectl delete -f https://github.com/cert-manager/cert-manager/releases/download/v1.12.11/cert-manager.crds.yaml
```
...
| `webhook.image.tag` | Webhook image tag | `v1.12.11` |
...
| `cainjector.image.tag` | cainjector image tag | `v1.12.11` |
...
| `acmesolver.image.tag` | acmesolver image tag | `v1.12.11` |
...
| `startupapicheck.image.tag` | startupapicheck image tag | `v1.12.11` |
